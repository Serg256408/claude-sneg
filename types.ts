...
const STATUS_LABELS: Record<OrderStatus, string> = {
  [OrderStatus.DRAFT]: 'Новая заявка',
  [OrderStatus.NEW_REQUEST]: 'Новая заявка',
  [OrderStatus.CALCULATING]: 'Согласование',
  [OrderStatus.AWAITING_CUSTOMER]: 'Согласование',
  [OrderStatus.CONFIRMED_BY_CUSTOMER]: 'Поиск техники',
  ...
  [OrderStatus.EXPORT_COMPLETED]: 'Завершено',
  [OrderStatus.REPORT_READY]: 'Завершено',
